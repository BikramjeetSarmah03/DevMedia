...
const PostsContainer = () => {
  ...
  return (
    <>
      <div className="flex flex-col w-full mb-8 lg:w-2/3 sm:mt-6 sm:px-8">
        {/* <StoriesContainer /> */}
        ...
        <InfiniteScroll
          ...
          loader={<SpinLoader />}
        >
          <div className="flex flex-col w-full h-full mt-1 space-y-4 sm:mt-6">
            {posts.length === 0 ? (
              <div className="text-3xl text-center xl:text-5xl">
                No Post Yet
              </div>
            ) : (
              posts?.map((post) => (
