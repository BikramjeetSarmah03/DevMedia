...
import { addComment, likePost, savePost } from "../../redux/actions/postAction";
...
const PostItem = ({
  ...
  return (
    <div className="relative flex flex-col bg-white border rounded">
      ...
      <div className="flex flex-col px-4 pb-2 mt-2 space-y-1 border-b">
        {/* icons container */}
        ...
        {viewComment && (
          <ScrollToBottom className="w-full py-1 overflow-y-auto h-52">
            {allComments.map((c) => (
      ...
      <form
        ...
        className="flex items-center justify-between w-full p-3 space-x-3"
      >
        <span
        ...
        <input
          className="flex-auto text-sm bg-transparent border-none outline-none"
          type="text"
          value={comment}
          ref={commentInput}
          required
