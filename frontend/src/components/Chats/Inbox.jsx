...
import { getUserDetailsById } from "../../redux/actions/userAction";
import {
  ALL_MESSAGES_ADD,
  NEW_MESSAGE_RESET,
...
const Inbox = () => {
  ...
  return (
    <>
      <MetaData title="DevMedia • Chats" />

      <div className="mt-14 sm:mt-[4.7rem] pb-4 rounded h-[90vh] xl:w-2/3 mx-auto sm:pr-14 sm:pl-8">
        <div className="flex w-full h-full bg-white border rounded">
          {/* sidebar */}
          <Sidebar openModal={openModal} />

          {!userId ? (
            <div className="flex flex-col items-center justify-center w-full gap-2 sm:w-4/6">
              <div className="flex items-center justify-center w-24 h-24 p-2 border-2 border-black rounded-full">
                <img
                  draggable="false"
                  loading="lazy"
            ...
            <div className="flex flex-col justify-between w-full sm:w-4/6">
              ...
              <div className="w-full flex-1 flex flex-col gap-1.5 overflow-y-auto overflow-x-hidden p-4">
                ...
                {isTyping && (
                  <>
                    <div className="flex items-center max-w-xs gap-3">
                      <img
                        draggable="false"
                        loading="lazy"
              ...
              >
                ...
                {message.trim().length > 0 ? (
                  <button className="text-sm font-medium text-primary-blue">
                    Send
                  </button>
                ) : (
                  <>
